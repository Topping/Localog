...
Start **TD-01B**. Implement ownership, sessionization, cleave grouping, confidence, and boundaries on
top of the bounded actor aggregates without retaining complete source lines or normalized event
collections.
