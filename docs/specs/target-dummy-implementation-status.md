...
Start **TD-01C**. Route one discovery pass automatically to the existing encounter path or synthetic
preparation while preserving typed errors and native encounter-import behavior.
