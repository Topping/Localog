...
Start **TD-02A**. Implement the bounded parser for the official SimulationCraft addon character
export, including structural limits and typed validation failures.
